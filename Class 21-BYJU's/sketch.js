...
function setup() {
  ...
  cube3 = new Cube(300,100,30,30);
  console.log("cube3: ");
  console.log(cube3)
  //construction of cube4 as object of Class CUBE using matter.js
  cube4 = new Cube(200,150,40,50);
}

//All changes, conditions, manipulations, actions to be executed and checked continously or 
//applied throughout the program are written inside function draw.
...
//NOTES: 
// classes are a library-things need to create a game-anything really-it also stores what kind of behavior that 
// object has. 
// counstructor-x,y,height,width, color,image,****body****-can be used as a property of the class. 
// display is the most basic behavior function(to display things/objects)-can be arranged in a rectangle,
// circle, or an image, etc. 
// class File will ALWAYS have a capital letter. EX: Box.js NOT box.js- Always add to index.html
// while using engine, world, and body(real life objects w/properties)- we can create several different bodies depending 
// on our world. 
// As soon as you create a body-you have to create a birth certificate(ADD it to the world)